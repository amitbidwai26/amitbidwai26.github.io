    ...
    <section id="home" class="slider-wrapper">
        <header>
            <div class="container">
                <div class="col-lg-3">
                    <figure>
                        <a href="index.html"><img src="./assets/images/logo.png" alt="logo-img"  width="160px" height="55px"></a>
                    </figure>
                </div>
                <div class="col-lg-9">
        ...
        <div class="footer-container">
            <div class="container">
                <div class="col-lg-5 col-md-3 col-sm-6 footer-left col-footer">
                    <a href="index.html"><img src="./assets/images/logo.png" class="img-responsive" alt="logo-img"  width="160px" height="55px"></a>
                    <div class="clearfix"></div>
